...
|---|---|---|---|
| PA_1 | 87 | Daily + overall duration | [`queries/pa1_daily_duration.sql`](queries/pa1_daily_duration.sql) |
| PA_2 | 397 | Daily by browser/OS | [`queries/pa2_browser_os_duration.sql`](queries/pa2_browser_os_duration.sql) |
| PA_3 | 6 | Funnel counts by browser/OS | [`queries/pa3_funnel_counts.sql`](queries/pa3_funnel_counts.sql) |
| PA_4 | 6 | Funnel rates by browser/OS | [`queries/pa4_funnel_rates.sql`](queries/pa4_funnel_rates.sql) |
| PA_5 | 2,506 | Individual abandoners | [`queries/pa5_individual_churners.sql`](queries/pa5_individual_churners.sql) |
| PA_8 | 173 | Clean path vs overall daily | [`queries/pa8_clean_path_overall.sql`](queries/pa8_clean_path_overall.sql) |
| PA_9 | 2 | Friction segments + revenue | [`queries/pa9_friction_segments.sql`](queries/pa9_friction_segments.sql) |
...
/queries  
pa1_daily_duration.sql  
pa2_browser_os_duration.sql  
pa3_funnel_counts.sql  
pa4_funnel_rates.sql  
pa5_individual_churners.sql  
pa8_clean_path_overall.sql  
pa9_friction_segments.sql  
aov_diagnostic.sql  
